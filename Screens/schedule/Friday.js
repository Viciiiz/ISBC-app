...
const Friday = () => {
  ...
  const boxesData = [
    ...
    { duration: 0.75, header: '', textTitle: 'Transition', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '8:45am', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
    { duration: 2.75, header: '', textTitle: 'Group Bible Study', textDetail: "(John 1:1-5 & 14)", textDetailTwo: "", titleLink: 'John 1:1-5 & 14', detailLink: 'John 1:1-5 & 14', detailTwoLink: 'John 1:1-5 & 14', time: '10:15am', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'no', done: 'no' },
    { duration: 0.75, header: '', textTitle: 'Transition', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '10:30am', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
    { duration: 4, header: '', textTitle: '"The Glory of Jesus, God incarnate"', textDetail: "(John 1:1-5 & 14)", textDetailTwo: "Eberhard Gross (Germany)", titleLink: 'John 1:1-5 & 14', detailLink: 'John 1:1-5 & 14', detailTwoLink: 'John 1:1-5 & 14', time: '11:45am', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'no', done: 'no' },
    ...
    { duration: 0.75, header: '', textTitle: 'Transition', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '2:00pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
    ...
    { duration: 0.75, header: '', textTitle: 'Transition', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '3:45pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
    { duration: 3.5, header: 'Special Lecture', textTitle: '"The Risen Lord and the Glory of Revival"', textDetail: "Dr. Timothy Tennent", textDetailTwo: "(President, Asbury Seminary)", titleLink: '', detailLink: 'personal site link', detailTwoLink: 'asbury link', time: '4:45pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'no', done: 'no' },
    ...
    { duration: 0.75, header: '', textTitle: 'Transition', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '7:00pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
    { duration: 3.5, header: '', textTitle: '"The Glory of Jesus\' Ministry: To Forgive Sins"', textDetail: "(Luke 5:17-26)", textDetailTwo: "John Fatoyinbo (Nigeria)", titleLink: 'Luke 5:17-26', detailLink: 'Luke 5:17-26', detailTwoLink: 'Luke 5:17-26', time: '', backgroundColor: '#fff', separation: 'no', meal: 'no', transition: 'no', done: 'no' },
    { duration: 3, header: '', textTitle: '"To Change Lives"', textDetail: "(Luke 5:27-32)", textDetailTwo: "Josue Gutierrez (Panama)", titleLink: 'Luke 5:27-32', detailLink: 'Luke 5:27-32', detailTwoLink: 'Luke 5:27-32', time: '7:50pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'no', done: 'no' },
    { duration: 0.75, header: '', textTitle: 'Break', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '8:00pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
