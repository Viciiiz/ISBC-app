...
const Saturday = () => {
  ...
  const boxesData = [
    ...
    { duration: 3.5, header: '', textTitle: '"The Glory of Risen Jesus: Encountering Paul"', textDetail: "(Acts 9:1-9)", textDetailTwo: "Mark Hui (Taiwan)", titleLink: 'Acts 9:1-9', detailLink: 'Acts 9:1-9', detailTwoLink: 'Acts 9:1-9', time: '', backgroundColor: '#fff', separation: 'no', meal: 'no', transition: 'no', done: 'no' },
    { duration: 3, header: '', textTitle: '"Empowering Paul"', textDetail: "(Acts 9:10-22)", textDetailTwo: "Abraham Yugai (KZ)", titleLink: 'Acts 9:10-22', detailLink: 'Acts 9:10-22', detailTwoLink: 'Acts 9:10-22', time: '8:10pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'no', done: 'no' },
    { duration: 0.75, header: '', textTitle: 'Break', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '8:20pm', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'yes', done: 'no' },
    ...
    { duration: 1.25, header: '', textTitle: '*Ice Cream Social', textDetail: "", textDetailTwo: "", titleLink: '', detailLink: '', detailTwoLink: '', time: '', backgroundColor: '#fff', separation: 'yes', meal: 'no', transition: 'no', done: 'no' },
